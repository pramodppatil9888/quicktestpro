...
class QuestionsController extends Controller
{
	...
	{
		$question_model = $this->loadModel($id);
			$model=new Answers;
		...
		if(isset($_POST['Answers']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$question_model->question_id));
		}

		
		
		$options_model=new Answers('search');
		$options_model->unsetAttributes();  // clear any default values
		$options_model->question_id = $question_model->question_id;		
		
		$this->render('view',array(
		'model'=>$question_model,'answer_model'=>$model,'options_model'=>$options_model
		));
	}
