 ...
 */
class Subjects extends CommonModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('subject_id, name, created_on, modified_on, created_by, modified_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'questions' => array(self::HAS_MANY, 'Questions', 'subject_id'),
